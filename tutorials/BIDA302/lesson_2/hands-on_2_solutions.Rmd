...
In R, variables come in a variety of types. For this tutorial, we will focus on numeric and logical variables.
...
Doubles get used when you need a number with a decimal point or a number bigger than roughly two billion. The maximum positive value for a 32-bit binary integer is 2,147,483,647 (2^31 - 1, which happens to be a [double Mersenne prime number](https://en.wikipedia.org/wiki/Double_Mersenne_number) for you number nerds).
