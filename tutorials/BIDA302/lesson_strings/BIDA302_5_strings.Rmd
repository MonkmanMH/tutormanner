...
```{r quiz2}
quiz(
  question('Which {stringr} function would you use to replace the vowels in "fruit_list" with an exclamation mark?',
    answer('str_detect(fruit_list, [aeiou], !)'),
    answer('str_detect(fruit_list, "[aeiou]", "!")'),
    answer('str_replace(fruit_list, [aeiou], !)'),
    answer('str_sub(fruit_list, [aeiou], !)d)')
  )
)
```

str_replace(x, pattern, newtext)
