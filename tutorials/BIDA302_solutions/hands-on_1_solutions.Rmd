...
* subset the data so that it contains only those records you are interested in (Why deal with every province in Canada when you just need the British Columbia data?)

* subset the data so taht it contains only those variables you are interested in (Why keep looking at variables that do not factor into your analysis?)
